...
figure; subplot(2,1,1); stem(coeff(:,1),'b-o'); title('Largest Eigenvector')
subplot(2,1,2); stem(coeff(:,2),'b-o'); title('2nd Largest Eigenvector')
